 ...
 <div class="container">
        <h1 class="about-title">Perpustakaan</h1>
        <p class="about-sub-title">Perpustakaan di SDN 2 Tugu, Pilih Passion Kamu!</p>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay=".1s">
                <div class="service-box2">
                    ...
                    <h3><a href="#">Kesenian dan Kebudayaan</a></h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay=".4s">
                <div class="service-box2">
                    ...
                    <h3><a href="#">Bersatu Kita Teguh, Bercerai Kita Runtuh</a></h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay=".7s">
                <div class="service-box2">
                    ...
                    <h3><a href="#">Penerapan Teknologi dalam Sosial Kemasyarakatan</a></h3>
